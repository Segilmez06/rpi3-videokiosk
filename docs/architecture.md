...
flowchart TD
    ...
    --> S4["<b>4. Userspace Init (OpenRC & Inittab)</b><br/>• /etc/inittab starts OpenRC sysinit, boot, & default runlevels<br/>• Spawns authenticated login on ttyAMA0 (xterm-256color)<br/>• Intentionally omits tty1-tty6 to keep HDMI clean<br/>• Launches OpenRC daemon: /etc/init.d/kiosk-player"]
