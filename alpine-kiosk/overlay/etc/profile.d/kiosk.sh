...
echo "    led status            - Inspect current LED state"
echo "    led green on/off      - Control Green ACT LED (or blink/heartbeat)"
echo "    led red on/off        - Control Red PWR LED (or heartbeat)"
