...
if [ -f "${ROOT_DIR}/assets/rebooting.png" ]; then
    cp "${ROOT_DIR}/assets/rebooting.png" "${SCRIPT_DIR}/overlay/usr/share/videokiosk/rebooting.png"
    python3 -c "
from PIL import Image
im = Image.open('${ROOT_DIR}/assets/rebooting.png').convert('RGB')
...
echo "    xzcat ${FINAL_XZ} | sudo dd of=/dev/sdX bs=64k status=progress oflag=sync"
echo "============================================================"
